...
const CallToActionSection: React.FC = () => {
  return (
    <div className="relative z-10 px-8 md:px-16 lg:px-24 py-24">
      <div
        className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 p-12 rounded-2xl border border-blue-500/30 backdrop-blur-sm container mx-auto">
        ...
        <p className="text-lg text-center mb-8 text-gray-300 max-w-2xl mx-auto">
          Lépjen kapcsolatba velünk még ma, és fedezze fel, hogyan alakíthatja át vállalkozását személyreszabott AI
          ügynökeinkkel.
        </p>
