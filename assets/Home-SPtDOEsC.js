 ...
 */const ee=s=>s.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),te=s=>s.replace(/^([A-Z])|[\s-_]+(\w)/g,(t,a,r)=>r?r.toUpperCase():a.toLowerCase()),T=s=>{const t=te(s);return t.charAt(0).toUpperCase()+t.slice(1)},K=(...s)=>s.filter((t,a,r)=>!!t&&t.trim()!==""&&r.indexOf(t)===a).join(" ").trim(),ae=s=>{for(const t in s)if(t.startsWith("aria-")||t==="role"||t==="title")return!0};/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const le=i.forwardRef(({color:s="currentColor",size:t=24,strokeWidth:a=2,absoluteStrokeWidth:r,className:n="",children:c,iconNode:b,...y},z)=>i.createElement("svg",{ref:z,...se,width:t,height:t,stroke:s,strokeWidth:r?Number(a)*24/Number(t):a,className:K("lucide",n),...!c&&!ae(y)&&{"aria-hidden":"true"},...y},[...b.map(([v,p])=>i.createElement(v,p)),...Array.isArray(c)?c:[c]]));/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const d=(s,t)=>{const a=i.forwardRef(({className:r,...n},c)=>i.createElement(le,{ref:c,iconNode:t,className:K(`lucide-${ee(T(s))}`,`lucide-${s}`,r),...n}));return a.displayName=T(s),a};/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=[["path",{d:"M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z",key:"l5xja"}],["path",{d:"M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z",key:"ep3f8r"}],["path",{d:"M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4",key:"1p4c4q"}],["path",{d:"M17.599 6.5a3 3 0 0 0 .399-1.375",key:"tmeiqw"}],["path",{d:"M6.003 5.125A3 3 0 0 0 6.401 6.5",key:"105sqy"}],["path",{d:"M3.477 10.896a4 4 0 0 1 .585-.396",key:"ql3yin"}],["path",{d:"M19.938 10.5a4 4 0 0 1 .585.396",key:"1qfode"}],["path",{d:"M6 18a4 4 0 0 1-1.967-.516",key:"2e4loj"}],["path",{d:"M19.967 17.484A4 4 0 0 1 18 18",key:"159ez6"}]],ne=d("brain",re);/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ie=[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"c24i48"}],["path",{d:"m19 9-5 5-4-4-3 3",key:"2osh9i"}]],oe=d("chart-line",ie);/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const me=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],W=d("chevron-right",me);/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const be=[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]],ke=d("lock",be);/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fe=[["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 18h16",key:"19g7jn"}],["path",{d:"M4 6h16",key:"1o0s65"}]],ye=d("menu",fe);/**
 * @license lucide-react v0.507.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],I=d("zap",Ce),Z=({className:s="",showGlow:t=!0})=>e.jsxs("div",{className:`relative z-10 ${s}`,children:[e.jsxs("div",{className:"text-3xl font-['Montserrat'] font-light tracking-tight",children:[e.jsx("span",{className:"text-white",children:"Q"}),e.jsx("span",{className:"text-[#ef4444]",children:"v"}),e.jsx("span",{className:"text-white",children:"AI"})]}),t&&e.jsx("div",{className:"absolute -inset-4 bg-blue-500/10 rounded-full blur-xl -z-10"})]}),Se=()=>{const[s,t]=i.useState(!1),[a,r]=i.useState(!1);return i.useEffect(()=>{const n=()=>{const c=window.scrollY>10;c!==s&&t(c)};return window.addEventListener("scroll",n),()=>{window.removeEventListener("scroll",n)}},[s]),e.jsxs("nav",{className:`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${s?"bg-black/70 backdrop-blur-lg py-3":"bg-transparent py-5"}`,children:[e.jsxs("div",{className:"container mx-auto px-6 md:px-12 flex justify-between items-center",children:[e.jsx(Z,{}),e.jsxs("div",{className:"hidden lg:flex items-center space-x-1",children:[[{label:"Szolgáltatások",href:"#szolgaltatasok"},{label:"Előnyök",href:"#elonyok"},{label:"Hogyan működik",href:"#hogyan-mukodik"},{label:"Kapcsolat",href:"#kapcsolat"}].map((n,c)=>e.jsxs("a",{href:n.href,className:"relative px-4 py-2 text-sm font-medium text-gray-200 hover:text-white transition-colors duration-200 group",children:[e.jsx("span",{className:"relative z-10",children:n.label}),e.jsx("span",{className:"absolute inset-0 rounded-full bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-200"})]},c)),e.jsxs("button",{className:"ml-4 relative group",children:[e.jsx("span",{className:"absolute inset-0 rounded-md bg-gradient-to-tr from-blue-600 to-purple-600 opacity-90 group-hover:opacity-100 blur-sm transition-all duration-200 group-hover:blur-md"}),e.jsx("span",{className:"relative block bg-gradient-to-tr from-blue-500 to-purple-600 rounded-md px-5 py-2 text-sm font-medium text-white",children:"Kapcsolatfelvétel"})]})]}),e.jsx("button",{className:"lg:hidden text-white p-2 focus:outline-none",onClick:()=>r(!a),children:a?e.jsx(Ae,{className:"h-6 w-6"}):e.jsx(ye,{className:"h-6 w-6"})})]}),e.jsx("div",{className:`lg:hidden fixed inset-0 bg-black/95 backdrop-blur-lg z-40 transform transition-transform duration-300 ease-in-out ${a?"translate-x-0":"translate-x-full"}`,children:e.jsxs("div",{className:"flex flex-col items-center justify-center h-full space-y-8 p-8",children:[[{label:"Szolgáltatások",href:"#szolgaltatasok"},{label:"Előnyök",href:"#elonyok"},{label:"Hogyan működik",href:"#hogyan-mukodik"},{label:"Kapcsolat",href:"#kapcsolat"}].map((n,c)=>e.jsx("a",{href:n.href,className:"text-xl font-medium text-gray-200 hover:text-white",onClick:()=>r(!1),children:n.label},c)),e.jsx("button",{className:"mt-4 bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-3 rounded-md text-white font-medium",onClick:()=>r(!1),children:"Kapcsolatfelvétel"})]})})]})},Ie=({className:s})=>{const t=i.useRef(null),a=i.useRef([]),r=i.useRef(0),n=i.useRef(0),b=i.useRef(1e3/24),y=i.useRef(0),z=i.useRef(0),v=180;return i.useEffect(()=>{const p=t.current;if(!p)return;const x=p.getContext("2d",{alpha:!1,desynchronized:!0});if(!x)return;const _=()=>{if(!p)return;const m=Math.max(window.innerWidth,document.documentElement.clientWidth),h=Math.max(window.innerHeight,document.documentElement.clientHeight),o=m,u=h,g=Math.min(window.devicePixelRatio||1,1.5);p.width=o*g,p.height=u*g,p.style.width="100%",p.style.height="100%",x.scale(g,g),a.current.length===0?X(o,u):P(o,u)},P=(m,h)=>{a.current.forEach(o=>{o.x<0&&(o.x=0),o.x>m&&(o.x=m),o.y<0&&(o.y=0),o.y>h&&(o.y=h)})},$=[{r:59,g:130,b:246},{r:147,g:51,b:234}],V=(m,h)=>{const o=Math.random()*m,u=Math.random()*h,g=$[Math.floor(Math.random()*$.length)];return{x:o,y:u,r:g.r,g:g.g,b:g.b,velocity:{x:(Math.random()-.5)*.4,y:(Math.random()-.5)*.4}}},X=(m,h)=>{const o=Math.max(60,Math.floor(m*h/15e3));a.current=[];for(let u=0;u<o;u++)a.current.push(V(m,h))},j=m=>{if(!x||!p){r.current=requestAnimationFrame(j);return}const h=m-n.current;if(h<b.current){r.current=requestAnimationFrame(j);return}n.current=m-h%b.current,y.current++,m-z.current>=1e3&&(y.current=0,z.current=m);const o=Math.max(window.innerWidth,document.documentElement.clientWidth),u=Math.max(window.innerHeight,document.documentElement.clientHeight),g=o,N=u,L=p.getBoundingClientRect();if(L.bottom<0||L.top>window.innerHeight){x.fillStyle="rgb(0, 0, 0)",x.fillRect(0,0,g,N),r.current=requestAnimationFrame(j);return}const R=h/(1e3/60);x.fillStyle="rgb(0, 0, 0)",x.fillRect(0,0,g,N);for(let k=0;k<a.current.length;k++){const l=a.current[k];l.x+=l.velocity.x*R,l.y+=l.velocity.y*R,l.x<0?(l.velocity.x=Math.abs(l.velocity.x),l.x=0):l.x>g&&(l.velocity.x=-Math.abs(l.velocity.x),l.x=g),l.y<0?(l.velocity.y=Math.abs(l.velocity.y),l.y=0):l.y>N&&(l.velocity.y=-Math.abs(l.velocity.y),l.y=N)}x.lineWidth=.8;for(let k=0;k<a.current.length;k++){const l=a.current[k];for(let w=k+1;w<a.current.length;w++){const f=a.current[w],B=l.x-f.x,q=l.y-f.y,F=B*B+q*q;if(F<v*v){const U=Math.sqrt(F),Y=Math.max(0,1-U/v),H=(M=>1-Math.pow(1-M,3))(Y);if(H>.02){const M=Math.floor((l.r+f.r)/2),D=Math.floor((l.g+f.g)/2),Q=Math.floor((l.b+f.b)/2);x.strokeStyle=`rgba(${M}, ${D}, ${Q}, ${H*.6})`,x.beginPath(),x.moveTo(l.x,l.y),x.lineTo(f.x,f.y),x.stroke()}}}}r.current=requestAnimationFrame(j)},E=()=>{_()};return _(),n.current=performance.now(),r.current=requestAnimationFrame(j),window.addEventListener("resize",E),()=>{window.removeEventListener("resize",E),cancelAnimationFrame(r.current)}},[]),e.jsx("canvas",{ref:t,className:s||"absolute inset-0 w-full h-full"})},_e=({time:s})=>e.jsxs("div",{className:"relative z-10 px-6 md:px-12 lg:px-24 h-screen pt-28 flex flex-col md:flex-row items-center justify-center",children:[e.jsxs("div",{className:"absolute inset-0 overflow-hidden",children:[e.jsx(Ie,{className:"absolute inset-0 w-full h-full"}),e.jsx("div",{className:"absolute inset-0 pointer-events-none",style:{background:`
